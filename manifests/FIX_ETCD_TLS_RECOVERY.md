...
| ------------- | ---------------------------- | ------ |
| **beelinkeqr5** | **192.168.100.2** і **192.168.200.2** | До macmini7 трафік може йти з source IP **192.168.200.2** (remote-addr у логах macmini7); до інших — 192.168.100.2. Обидва потрібні в tls-san. |
